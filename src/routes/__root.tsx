  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <img src={BRAND.logoLight} alt={BRAND.name} className="h-14 w-auto mx-auto mb-8 object-contain" />
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modern luxury fashion. Considered essentials designed in New York, made in Europe." },
      { name: "author", content: BRAND.name },
      { property: "og:site_name", content: BRAND.name },
      { property: "og:title", content: `${BRAND.name} — ${BRAND.tagline}` },
      { property: "og:description", content: "Modern luxury fashion. Considered essentials designed in New York, made in Europe." },
